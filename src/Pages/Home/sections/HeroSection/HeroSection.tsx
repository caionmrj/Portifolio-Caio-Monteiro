...
const HeroSection: React.FC = () => {
    ...
    const handleDownload = () => {
        ...
        link.href = CV
        link.download = 'Curriculo Caio Monteiro.pdf'; // Set the download attribute to specify the file name
                ...
                <Container maxWidth="lg">
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={7}>
                            ...
                            <Typewriter text="Dev Júnior" delay={120} variant="h2" color="primary.contrastText" />
                            <Box mt={3}>
